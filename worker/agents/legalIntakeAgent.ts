...
import { LawyerSearchService } from '../services/LawyerSearchService';
import type { Env, FileAttachment } from '../types';
import type { Team } from '../services/TeamService';
import type { ErrorResult } from './legal-intake/errors';
import { createSuccessResult, createErrorResult, ValidationError, ExternalServiceError } from './legal-intake/errors';
...
// buildCaseDraft tool definition removed - now handled by caseDraftMiddleware

// showDocumentChecklist tool definition removed - now handled by documentChecklistMiddleware

// skipToLawyer tool definition removed - now handled by skipToLawyerMiddleware
...
// handleBuildCaseDraft removed - now handled by caseDraftMiddleware

// handleShowDocumentChecklist removed - now handled by documentChecklistMiddleware

// handleSkipToLawyer removed - now handled by skipToLawyerMiddleware