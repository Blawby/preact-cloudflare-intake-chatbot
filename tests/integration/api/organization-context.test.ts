...
describe('Organization Context Integration', () => {
  it('should handle session creation with organization context from URL', async () => {
    ...
    expect(data.data.organizationId).toBe('blawby-ai');
  ...
  it('should handle session retrieval with organization context', async () => {
    ...
    expect(getData.data.organizationId).toBe('blawby-ai');
  });
});
