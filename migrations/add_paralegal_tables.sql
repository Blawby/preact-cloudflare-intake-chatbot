...
CREATE TABLE IF NOT EXISTS matter_formation_stages (
  ...
  stage TEXT NOT NULL, -- collect_parties, conflicts_check, documents_needed, fee_scope, engagement, filing_prep, completed
  status TEXT DEFAULT 'pending', -- pending, in_progress, completed, skipped
  data JSON, -- Stage-specific data and metadata
  started_at DATETIME,
...
CREATE TABLE IF NOT EXISTS conflict_checks (
  id TEXT PRIMARY KEY,
  matter_id TEXT NOT NULL,
  parties JSON NOT NULL, -- Array of party names checked
  result JSON, -- Conflict check results with details
  cleared BOOLEAN DEFAULT FALSE, -- Whether conflicts were cleared
...
CREATE TABLE IF NOT EXISTS document_requirements (
  ...
  required BOOLEAN DEFAULT TRUE, -- Whether this document is required or optional
  status TEXT DEFAULT 'pending', -- pending, requested, received, reviewed, approved
...
CREATE TABLE IF NOT EXISTS engagement_letters (
  ...
  status TEXT DEFAULT 'draft', -- draft, sent, reviewed, signed, executed
  sent_at DATETIME,
  signed_at DATETIME,
