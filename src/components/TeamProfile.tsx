	...
	return (
		<div className={`team-profile ${variant}`}>
			...
			<div className="team-name">
				...
				{showVerified && (
					<svg className="w-5 h-5 sm:w-6 sm:h-6 text-gray-900 dark:text-white ml-1 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20" aria-label="Verified" title="Verified">
