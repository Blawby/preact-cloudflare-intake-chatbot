...
async function testDatabaseTeamConfig() {
  console.log('🔍 Testing Database Team Config...\n');
    ...
    const response = await fetch('https://blawby-ai-chatbot.paulchrisluke.workers.dev/api/agent', {
      ...
      body: JSON.stringify({
        messages: [
          {
            role: 'user',
            content: 'I need help with a family law matter. My name is John Doe, my email is john@example.com, and my phone is 555-123-4567. I live in Charlotte, NC. I have a custody dispute with my ex-spouse.'
          }
        ],
